...
?>
<h3 style="color: green;text-align: center" id="msj-editado"></h3>
<form action="" id="formEditProducto">
    <table class="paneles">
        ...
        <tr>
            <td>nombre</td>
            <td><input type="text" name="prd_nombre" value="<?php echo $p->prd_nombre; ?>"></td>
        </tr>
        <tr>
            <td>descripcion</td>
            <td><textarea name="prd_descripcion" id="" cols="20" rows="3"><?php echo $p->prd_descripcion; ?></textarea></td>
        </tr>
        <tr>
            <td>precio</td>
            <td><input type="text" name="prd_precio" value="<?php echo $p->prd_precio; ?>"></td>
        </tr>
        <tr>
            <td>categoria</td>
            <td>
                <select name="cat_id" id="">
                    <?php
                        foreach ($categorias->result() as $c) {
                            ?>
                            <option <?php if ($p->cat_id == $c->cat_id){ echo 'selected'; } ?> value="<?php echo $c->cat_id; ?>"><?php echo $c->cat_nombre; ?></option>
                            <?php
                        }
                    ?>
                </select>
